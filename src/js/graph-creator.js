document.onload = (function(d3, saveAs, Blob, undefined){
  ...
  var GraphCreator = function(svg, nodes, edges) {
    ...
    thisGraph.drag = d3.behavior.drag()
          ...
          .on("drag", function(args){
            thisGraph.state.isDragged = true;
      ...
      if (window.File && window.FileReader && window.FileList && window.Blob) {
        ...
        filereader.onload = function(){
          ...
          try{
            ...
            thisGraph.setNewNodeId(jsonObj.nodes.length + 1);
   ...
   /* PROTOTYPE FUNCTIONS */
  GraphCreator.prototype.setNewNodeId = function(newId){
  ...
  GraphCreator.prototype.dragmove = function(d) {
    var thisGraph = this;
    if (thisGraph.state.isShiftNodeDrag){
  ...
  GraphCreator.prototype.insertTitleLinebreaks = function (gEl, title) {
    ...
    var el = gEl.append("text")
	  .attr("x", String(thisGraph.consts.nodeWidth/2))
	  .attr("y", String(thisGraph.consts.nodeHeight/2))
    ...
    for (var i = 0; i < words.length; i++) {
      ...
      if (i > 0) {
	tspan.attr("x", String(thisGraph.consts.nodeWidth/2)).attr('dy', '15');
  ...
  GraphCreator.prototype.updateGraph = function(){
    ...
    paths.style('marker-end', 'url(#marker-circle)')
    ...
    thisGraph.circles.attr("transform", function(d){return "translate(" + (d.x - consts.nodeWidth/2 ) + "," + (d.y - consts.nodeHeight/2) + ")";});
...
//    thisGraph.circles.attr("transform", function(d){return "translate(" + d.x + "," + d.y + ")";});
    ...
    newGs.classed(consts.circleGClass, true)
      ...
      .attr("transform", function(d){return "translate(" + (d.x - consts.nodeWidth/2 ) + "," + (d.y - consts.nodeHeight/2) + ")";})
      .on("mouseover", function(d){
        if (state.isShiftNodeDrag){
